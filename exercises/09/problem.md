Your competitor is fed up with the lackluster results from the UC Berkeley graduate and decide to hire an OSU student who has completed [CS499/579: Web Security](https://websec.osu-security.com) instead. They are able to quickly implement a foolproof `htmlElementEscape()` function which defeats your shenanigans once and for all.
